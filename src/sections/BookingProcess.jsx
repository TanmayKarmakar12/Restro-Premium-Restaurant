        ...
        <section id='booking-process' className='px-auto mt-44'>
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 md:gap-25">
                ...
                <div className='flex flex-col text-center md:text-left'>
                    <Animated delay={0.2}>
                        <p className='text-orange-500 font-medium uppercase mb-4'>Reserve your
                    ...
                    <Animated className="flex items-center justify-center md:justify-start gap-3">
                        <img src={bookingTestimonial.authorImg} alt={bookingTestimonial.authorImg} className='size-12 rounded-full object-cover' />
